...
def processCmdLine():
	...
	parser.add_argument('--initcmdreq_guid', help=argparse.SUPPRESS, type=str.lower, default='0x7766554433221100-0xFFEEDDCCBBAA9988', required=False) # GUID order in string is high-low
...
#	serialNumberStr = removeLeadingCharsFromStr(serialNumberStr, {' ', '0'}) # remove leading spaces/zeros from serial number
	serialNumberStr = '1234'  #hard-coded serial to test - jbb
